...
<head>
    <meta charset="utf-8"><title>View receiver of food</title>
 ...
 <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5"><?php echo $_SESSION['RNAME'] ?> : Available food list are here...</h1>
            </div>
            ...
            <div class="row g-4">
			 ...
			 <?php
			   ...
			   $conn =connectdb();
				...
				$sql="Select * from food where admin_status=1 and food_status=0" ;
				...
				if($result->num_rows>0)
				{
                    ...
                    <div class="team-item bg-light">
                        ...
                        <div class="text-center p-4">
							...
							<small>Uploaded date : '.$row["adate"].'</small><br><br>
						
							<button><a href="allaction.php?cno='.$row["fno"].'">Claim</a></button>
                        </div>
                    </div>
                </div>
