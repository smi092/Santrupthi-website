...
<head>
    <meta charset="utf-8">
    <title>Santrupti - View receivers</title>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                <a href="adashboard.php" class="nav-item nav-link active">Home</a>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Receivers List</h1>
...
<div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-primary px-3">Receivers</h6>
                <h1 class="mb-5">Receivers Available</h1>
            </div>

			<ol class="breadcrumb w3l-crumbs">
			<li><a href="adashboard.php"><i class="fa fa-home"></i> Admin dashboard </a></li> 
			<li class="active"> / View receivers</li>
		</ol>
				...
				if($result->num_rows>0)
				{
                    ...
                    <div class="team-item bg-light">
                        ...
                        <div class="text-center p-4">
                            ...
                            <small>Mobile No. : '.$row["rmblno"].'</small><br>
							<small>Address : '.$row["raddress"].'</small><br>
							<small>Email : '.$row["remail"].'</small><br>
							<small><a href="allaction.php?uid='.$row["uid"].'"> Delete</a></small>
                        </div>
                    </div>
                </div>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        ...
                        Designed By <a class="border-bottom" href="admin.html">Rachitha & Ashwini</a><br><br>
