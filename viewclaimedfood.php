...
<head>
    <meta charset="utf-8">
    <title>Santrupti - View claimed food</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a href="dlogin.php" class="btn btn-primary py-4 px-lg-5 d-none d-lg-block">Donate Now<i class="fa fa-arrow-right ms-3"></i></a>
        </div>
    </nav>
    <!-- Navbar End -->
 ...
 <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-primary px-3">Claimed Food</h6>
                <h1 class="mb-5"><?php echo $_SESSION['RNAME'] ?> : Claimed food list are here...</h1>
            </div>
            ...
            <div class="row g-4">
			 ...
			 <?php
			   ...
			   $conn =connectdb();
				...
				$sql="Select * from food,donor where food.donor_id=donor.did and admin_status=1 and food_status=1 " ;
				...
				if($result->num_rows>0)
				{
                    ...
                    <div class="team-item bg-light">
						...
						<small>Donor Name: '.$row["dname"].'</small><br><br>
						<small>Donor Mobile No.: '.$row["dmblno"].'</small><br>
						<small>Donor Gender: '.$row["dgender"].'</small><br>
						<small>Donor Address: '.$row["daddress"].'</small><br>
						<small>Donor State: '.$row["dstate"].'</small><br>
						<small>Donor City: '.$row["dcity"].'</small><br>
						<small>Donor Email: '.$row["demail"].'</small><br>
                        <button><a href="allaction.php?fno='.$row["fno"].'">Delete</a></button>	
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="d-flex pt-2">
                        <a class="btn btn-outline-light btn-social" href="https://twitter.com/sushanthdevadiga?t=YtgbWOicYx36jxCL73lhOQ&s=08"><i class="fab fa-twitter"></i></a>
                        ...
                        <a class="btn btn-outline-light btn-social" href="https://www.linkedin.com/in/Smitha G"><i class="fab fa-linkedin-in"></i></a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
