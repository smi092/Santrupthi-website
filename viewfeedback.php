...
<head>
    <meta charset="utf-8">
    <title>Santrupti - View Feedback</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        <a href="index.html" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h2 class="m-0 text-primary"><img style= "width:9%;height:9% me-3"  src="img/icon.jpg" alt="">Sαɳƚɾυρƚι</h2></div>
        </a>
				...
				if($result->num_rows>0)
				{
                    ...
                    <div class="team-item bg-light">
                        ...
                        <div class="text-center p-4">
                            <h5 class="mb-0">Name : '.$row["fname"].'</h5><br>
                            <small>Message : '.$row["message"].'</small><br>
							<small><a href="allaction.php?slno='.$row["slno"].'"> Delete</a></small>
                        </div>
                    </div>
                </div>
