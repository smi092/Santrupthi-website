...
<head>
    <meta charset="utf-8">
    <title>Santrupti - User feedback page</title>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                <a href="rdashboard.php" class="nav-item nav-link active">Home</a>              
            </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">Drop your feedback here</h1>
            </div>
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
                   <form name="feedback" action="userfeedbackstore.php" method="post" class="main_form">
                        <div class="row g-3">
						<label>UID :<?php echo $_SESSION['UID'] ?></label>
                            <label>Name :<?php echo $_SESSION['RNAME'] ?></label>
									<label>Email :<?php echo $_SESSION['REMAIL'] ?></label>
                            
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="usubject" placeholder="Subject" style="width=device-width" >
                                    <label for="subject">Subject</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control" name="umessage" placeholder="Leave a message here" style="height: 150px; width=device-width"></textarea>
                                    <label for="message">Message</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <button class="btn btn-primary w-100 py-3" type="submit" name="btnsubmit" style="width=device-width">Send Message</button>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel position-relative">
                <div class="testimonial-item text-center">
                    ...
                    <h5 class="mb-0">Khushi</h5>
                    <p>Social Servicer</p>
                    <div class="testimonial-text bg-light text-center p-4">
                    <p class="mb-0">Its really a good website which helped us lot to make social service and we can find many donors who are willing to help the needy one's.</p>
                    </div>
                </div>
                <div class="testimonial-item text-center">
                    <img class="border rounded-circle p-2 mx-auto mb-3" src="img/testimonial-1.jpg" style="width: 80px; height: 80px;">
                    <h5 class="mb-0">Raghavendra</h5>
                    <p>Public figure</p>
                    <div class="testimonial-text bg-light text-center p-4">
                    <p class="mb-0">I really loved this website which really impressed me with its interface and its features are really user friendly</p>
                    </div>
                </div>
                <div class="testimonial-item text-center">
                    <img class="border rounded-circle p-2 mx-auto mb-3" src="img/testimonial-2.jpg" style="width: 80px; height: 80px;">
                    <h5 class="mb-0">Gagan</h5>
                    <p>Social Worker</p>
                    <div class="testimonial-text bg-light text-center p-4">
                    <p class="mb-0">I'm very much happy with this website and its cause is very helpful to us.</p>
                    </div>
                </div>
                <div class="testimonial-item text-center">
                    ...
                    <p>Public</p>
                    <div class="testimonial-text bg-light text-center p-4">
                    <p class="mb-0">Its really a great website where we can find many donors as well the receivers who are willing to help the needy people</p>
                    </div>
                </div>
            </div>
        </div>
