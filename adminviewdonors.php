...
<head>
    <meta charset="utf-8">
    <title>Santrupti - Admin View Donors</title>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Donors</h1>
...
<div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-primary px-3">Donors</h6>
                <h1 class="mb-5">Donors Available</h1>
            </div>
				...
				if($result->num_rows>0)
				{
                    ...
                    <div class="team-item bg-light">
                        ...
                        <div class="text-center p-4">
                            <h5 class="mb-0">Name : '.$row["dname"].'</h5><br>
                            <small>Mobile No. : '.$row["dmblno"].'</small><br>
							<small>Address : '.$row["daddress"].'</small><br>
							<small>Email : '.$row["demail"].'</small><br>
							<small><a href="allaction.php?did='.$row["did"].'"> Delete</a></small>
                        </div>
                    </div>
                </div>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        ...
                        Designed By <a class="border-bottom" href="admin.html">Rachitha & Smitha</a><br><br>
