...
<head>
    <meta charset="utf-8">
    <title>Santrupti - Donors List</title>
...
<div class="container-xxl py-5">
        <div class="container">
			...
			<li><a href="rdashboard.php"><i class="fa fa-home"></i> Receiver dashboard </a></li> 
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="row g-2 pt-2">
                        ...
                        <div class="col-4">
                            <img class="img-fluid bg-light p-1" src="img/fd.jpg" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
