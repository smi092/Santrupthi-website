...
<head>
    <meta charset="utf-8">
    <title>Santrupti - Receiver Dashboard</title>
...
<body>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Welcome :<?php echo $_SESSION['RNAME'] ?> to Dashboard </h1>
    ...
    <div class="container-xxl py-5">
		...
		<ol class="breadcrumb w3l-crumbs">
			...
			<li class="active"> / Receiver dashboard</li>
		</ol>
            ...
            <div class="row g-4">
				...
				<a href="viewfoodreceiver.php">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            <i class="fas fa-concierge-bell fa-3x text-primary mb-4"></i>
                            <h5 class="mb-3">Search Available Food</h5>
                        </div>
                    </div>
					</a>
                </div>
				...
				<a href="receiverviewdonor.php">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            <i class="fas fa-users fa-3x text-primary mb-4"></i>
                            <h5 class="mb-3">Search Donors</h5>
                        </div>
                    </div>
					</a>
                </div>
				...
				<div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
				<a href="viewclaimedfood.php">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            <i class="fas fa-users fa-3x text-primary mb-4"></i>
                            <h5 class="mb-3">View Claimed Food</h5>
                        </div>
                    </div>
					</a>
                </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Woodlands, udupi, India</p>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        ...
                        Designed By <a class="border-bottom" href="admin.html">Rachitha & Team</a><br><br>
                        Distributed By <a class="border-bottom" href="https://themewagon.com">UMBVA</a>
                    </div>
